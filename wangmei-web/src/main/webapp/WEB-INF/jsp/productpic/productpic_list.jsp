		...
		<div class="main_container">
			...
			<div class="right_col" role="main">
				...
				<table class="table">
					...
					<c:forEach items="${page.list}" var="productpic">
						<tr>
							<td>${productpic.picid}</td>
							<td>${productpic.pid}</td>
							<td><img src="${productpic.picurl}" width="60px" height="40px"></td>
							<td>${productpic.sort}</td>
							<td>${productpic.adduser}</td>
							<td>${productpic.addtime}</td>
							<td>${productpic.modifyuser}</td>
							<td>${productpic.modifytime }</td>
						</tr>
					</c:forEach>
				</table>
				<nav aria-label="Page navigation">
				  <ul class="pagination">
				    <li>
				      <a href="/productPicView?pageNum=${page.pageNum-1<1?1:(page.pageNum-1)}" aria-label="Previous">
				    ...
				    <c:forEach begin="1" end="${page.pages}" varStatus="status">
				    	<c:choose>
				    		...
				    		<a href="/productPicView?pageNum=${status.index}">${status.index}</a>
				    	</li>
				    </c:forEach>
				    <li>
				      <a href="/productPicView?pageNum=${page.pageNum+1>page.pages?page.pages:(page.pageNum+1)}" aria-label="Next">
