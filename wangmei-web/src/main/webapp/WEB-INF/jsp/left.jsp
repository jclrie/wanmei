...
<div class="col-md-3 left_col">
	<div class="left_col scroll-view">
		<div class="navbar nav_title" style="border: 0;">
			<a href="/indexview" class="site_title"><i class="fa fa-paw"></i>
		...
		<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
			<div class="menu_section">
				...
				<ul class="nav side-menu">
					<li><a><i class="fa fa-home"></i> 商品管理 <span
							class="fa fa-chevron-down"></span></a>
						<ul class="nav child_menu">
							<li><a href="/indexview">商品列表</a></li>
							<li><a href="/productPicView">商品图片列表</a></li>
							<li><a href="/categoryView">分类列表</a></li>
						</ul></li>
					<li><a><i class="fa fa-edit"></i> 订单管理 <span
							class="fa fa-chevron-down"></span></a>
						<ul class="nav child_menu">
							<li><a href="/orderProductView">订单列表</a></li>
							<li><a href="/addressView">送货地址</a></li>
				...
				<!-- 	<li><a><i class="fa fa-desktop"></i> UI Elements <span
					...
					<!-- <li><a><i class="fa fa-table"></i> 添加操作 <span
							class="fa fa-chevron-down"></span></a>
						<ul class="nav child_menu">
							<li><a href="/productAddShow">添加商品</a></li>
							<li><a href="/categoryAdd">添加分类</a></li>
						</ul></li> -->
						<!--  
