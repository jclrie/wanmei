	...
	<div class="container body">
		<div class="main_container">
			...
			<div class="right_col" role="main">
				...
				<div class="form-group">
					<label class="control-label col-md-3 col-sm-3" for="pname">订单ID
				...
				<div class="form-group">
					<label class="control-label col-md-3 col-sm-3" for="ppoint">地址
						<span class="required">*</span>
					</label>
					<div class="col-md-6 col-sm-6">
						<input type="text" id="ppoint" name="ppoint" required="required"
							class="form-control col-md-7 col-xs-12">
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-3 col-sm-3" for="price">商品数量
						<span class="required">*</span>
					</label>
					<div class="col-md-6 col-sm-6">
						<input type="text" id="price" onkeyup="num(this)" name="price"
							required="required" class="form-control col-md-7 col-xs-12">
					</div>
				</div>
				<div class="form-group">
					<label for="middle-name" class="control-label col-md-3 col-sm-3">商品状态</label>
					<div class="col-md-2 col-sm-2">
						<input type="button" id="J_selectImage"
							class="form-control col-md-2 col-xs-4" value="图片上传" />
					</div>
				...
				<div class="form-group">
					<label for="middle-name" class="control-label col-md-3 col-sm-3">打折*</label>
					<div class="col-md-2 col-sm-2">
						<textarea name="information" cols="100" rows="8"
				...
				<table class="table">
					...
					<c:forEach items="${page.list}" var="order">
						<tr>
							...
							<td>${order.paycode }</td>
							<td>${order.issuccess }</td>
							<td><a class="btn btn-danger" id="delBnt"
								href="javascript:deleteProduct('${order.oid}')" role="button">删除</a>
							</td>
						</tr>
					</c:forEach>
				</table>
		...
		<script type="text/javascript">
			function deleteProduct(oid) {
				if (confirm('确定删除？')) {
					location.href = '/orderDelete?oid=' + oid;
				}
			}
		</script>
		<!-- Flot -->
