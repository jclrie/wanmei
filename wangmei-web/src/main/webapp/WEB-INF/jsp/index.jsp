	...
	<div class="container body">
		<div class="main_container">
			...
			<div class="right_col" role="main">
				...
				<a class="btn btn-default" href="/productAddShow" role="button">添加商品</a>
				<table class="table">
					<tr>
						<td>产品ID</td>
						<td>产品名称</td>
					...
					<c:forEach items="${page.list}" var="product">
						<tr>
							<td>${product.pid}</td>
							<td>${product.pname}</td>
							<td>${product.ppoint}</td>
							<td>${product.price}</td>
							<td>${product.information}</td>
							<td>
							<a class="btn btn-info" href="/productUpdateShow?pid=${product.pid}" role="button">修改</a>
							<a class="btn btn-danger" id="delBnt" href="javascript:deleteProduct('${product.pid}')" role="button">删除</a>
							<a class="btn btn-warning" role="button" href="/kuidShow?pid=${product.pid}">修改库存</a>
							</td>
						</tr>
					</c:forEach>
				</table>
				<nav aria-label="Page navigation">
				  <ul class="pagination">
				    <li>
				      <a href="/indexview?pageNum=${page.pageNum-1<1?1:(page.pageNum-1)}" aria-label="Previous">
				    ...
				    <c:forEach begin="1" end="${page.pages}" varStatus="status">
				    	<c:choose>
				    		...
				    		<a href="/indexview?pageNum=${status.index}">${status.index}</a>
				    	</li>
				    </c:forEach>
				    <li>
				      <a href="/indexview?pageNum=${page.pageNum+1>page.pages?page.pages:(page.pageNum+1)}" aria-label="Next">
