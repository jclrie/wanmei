      ...
      <%@ include file="nav.jsp" %>
        ...
        <div class="right_col" role="main">
                        ...
                        <form class="form-horizontal form-label-left" id="AddForm" >
                          ...
                          <span class="section">修改商品基本信息</span>
                          ...
                          <!-- Button trigger modal -->
							...
							<input type="hidden" value="${category.cid}" name="cid" id="pid"><span>${category.cname}</span>
							<!-- Modal -->
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6">
                              <input type="text" id="pname" name="pname" required="required" value="${product.pname}" class="form-control col-md-7 col-xs-12">
                            </div>
                          </div>
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6">
                              <input type="text" id="ppoint" value="${product.ppoint}" name="ppoint" required="required" class="form-control col-md-7 col-xs-12">
                            </div>
                          </div>
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6">
                              <input type="text" id="price" onkeyup="this.value=this.value.replace(/[^\d.]/g,'')" name="price" value="${product.price}" required="required" class="form-control col-md-7 col-xs-12">
                            </div>
                          </div>
                          <div class="form-group">
                            ...
                            <div id="J_imageView" style="width: 50px;height: 50px"></div>                              
							  <input name="imgurl" type="hidden" id="imgurl" value="${product.imgurl}">
							</div>
                          </div>
                          <div class="form-group">
                            <label for="middle-name" class="control-label col-md-3 col-sm-3">商品说明*</label>
                            <div class="col-md-2 col-sm-2">
                            	<textarea name="information" cols="100" rows="8" style="width: 700px; height: 200px; visibility: hidden;">${product.information}</textarea>
                            </div>
                          </div>
                          <div class="form-group">
                          	<div class="col-md-2 col-sm-2 col-md-offset-3">
                            	<button type="button" id="btnAdd" class="btn btn-primary">修改</button>
...
// 				alert(param);
    ...
    <script type="text/javascript">
		    KindEditor.ready(function(K) {	
		            ...
		            div.html('');
		            if('${product.imgurl}'!=''){
			            div.append('<img style="width:50px;height:50px;" src="${product.imgurl}">');
			            K('#imgurl').attr('value','${product.imgurl}');
		            }
		    });
	         KindEditor.ready(function(K) {
	            var editor = K.editor({
