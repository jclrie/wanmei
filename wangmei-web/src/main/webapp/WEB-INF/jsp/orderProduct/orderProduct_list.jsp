		...
		<div class="main_container">
			...
			<div class="right_col" role="main">
				...
				<table class="table">
					...
					<c:forEach items="${page.list}" var="order">
						<tr>
							...
							<td>
								<a class="btn btn-danger" id="delBnt" href="javascript:deleteProduct('${order.oid}')" role="button">删除</a>
							</td>
						</tr>
					</c:forEach>
				</table>
				<nav aria-label="Page navigation">
				  <ul class="pagination">
				    <li>
				      <a href="/orderProductView?pageNum=${page.pageNum-1<1?1:(page.pageNum-1)}" aria-label="Previous">
				    ...
				    <c:forEach begin="1" end="${page.pages}" varStatus="status">
				    	<c:choose>
				    		...
				    		<a href="/orderProductView?pageNum=${status.index}">${status.index}</a>
				    	</li>
				    </c:forEach>
				    <li>
				      <a href="/orderProductView?pageNum=${page.pageNum+1>page.pages?page.pages:(page.pageNum+1)}" aria-label="Next">
